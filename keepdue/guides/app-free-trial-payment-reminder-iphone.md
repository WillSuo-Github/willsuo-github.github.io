# App free trial asks for payment info? Set the reminder before you leave the screen
...
2. Find the renewal, conversion, or cancellation date.
3. Record the service name and date before closing the screen.
4. Set the first reminder before the final decision day.
5. Add an earlier backup reminder for expensive trials, annual plans, or anything you are unsure about.
