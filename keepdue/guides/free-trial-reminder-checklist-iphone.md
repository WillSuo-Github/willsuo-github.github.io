...
Use this checklist when you start a trial:

1. Write down the service name immediately.
2. Add the trial conversion or renewal date before leaving the sign-up flow.
...
KeepDue is built for that smaller job. It lets you add a trial or subscription manually, see what is due next, and get local reminders before the charge. It does not require bank linking or an account.

KeepDue is free for up to 5 active subscriptions on one device.
